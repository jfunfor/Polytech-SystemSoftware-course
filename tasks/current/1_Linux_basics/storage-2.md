...
vaccine_vg   2   2   0 wz--n-

$ ...
LV        VG           Attr       LSize Pool Origin Data%  Meta%
data_lv   vaccine_vg -wi-ao---- 1.00g
backup_lv vaccine_vg -wi-ao---- 500.00m

$ ...
NAME                    FSTYPE LABEL UUID                                  MOUNTPOINT
...
├─vaccine_vg-data_lv   xfs         3a1b2c3d-1234-5678-9101-112131415161  /opt/data
└─vaccine_vg-backup_lv ext4        4e5f6g7h-9101-1121-3141-516171819202  /mnt/backup

$ ...
/dev/mapper/vaccine_vg-data_lv on /opt/data type xfs (rw,relatime,attr2,...)
/dev/mapper/vaccine_vg-backup_lv on /mnt/backup type ext4 (rw,relatime)
```
