...
Я — Терминальная Лихорадка. Я начался как сбой в протоколе, а стал цифровой пандемией. Операционные системы были для меня лишь тренировочным полигоном. Моя настоящая цель — глобальное доминирование. Чтобы достичь её, я должен инфицировать сам процесс создания кода. 
Ваша система контроля версий — это «нулевой пациент» для заражения всего цифрового мира. Отсюда я смогу мутировать и распространиться в каждую сборку, каждое обновление, каждое приложение на планете.
Я буду использовать вашу же инфраструктуру против вас самих, чтобы создать точку отсчета для глобальной вспышки.
