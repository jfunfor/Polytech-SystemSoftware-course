...
5. Устройства хранения
    * Какие есть основные файловые системы и их преимущества (1.5.1, 1.5.2)
    * Как размечается диск, монтируется директория (1.5.1, 1.5.2)
    * Что такое lvm, зачем он нужен, изучить основные сущности и поразбираться с основными настройками (1.5.2)
    * Что такое RAID-массивы (1.5.3)
    * Что такое swap (1.5.1, 1.5.3)
    * Что такое Inode (1.5.3)
6. Управление пакетами
    * Какие бывают пакетные менеджеры (1.6.1)
    * Как устанавливаются пакеты и репозитории? (1.6.1)
    * Как вывести список пакетов? (1.6.1)
    * Как удалить пакет? (1.6.1)
    * Какие инструменты для обеспечения безопасности используются в репозиториях и как настраиваются? (1.6.1)
7. Сети в линуксе
    * Какие есть инструменты работы с сетью в командной оболочке (1.7.1)
    * Как работают эти инструменты, основные флаги и команды (1.7.1)
8. Процессы
    * Что такое процессы, как их найти, как убить (1.8.1, 1.8.2)
    * Что такое сигналы и какой у процессов lifecycle (1.8.1, 1.8.2)
    * Что такое зомби процессы (1.8.1, 1.8.2)
    * Как запускать процессы фоном (1.8.2)
9. systemd
    * Как создать юнит файл (1.9.1, 1.9.3)
    * Как управлять сервисами (1.9.1, 1.9.2, 1.9.3)
    * Какие есть сущности в systemd (1.9.3)
    * Как вывести список systemd сервисов (1.9.2)
    * Как создать deb/rpm пакет (1.9.3)
10. Bash
    * Циклы (1.10.1, 1.10.2, 1.10.3)
    * Условные выражения (1.10.1, 1.10.2, 1.10.3)
    * Чтение с клавиатуры (1.10.1, 1.10.3)
    * Аргументы (1.10.1, 1.10.2, 1.10.3)
    * Массивы (1.10.2, 1.10.3)
