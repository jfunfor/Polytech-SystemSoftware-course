...
### Базы данных
* включить не ток sql, но и все варианты бд - clickhouse, cassandra, postgresql, redis, prometheus, elasticsearch, mongodb

вкратце о зоопарке баз данных - виды, преимущества
как деплоить каждую бд, отказоустойчивость и пр.
как пользоваться бд, основные особенности

### Мониторинг, Алертинг, Трейсинг
